...
<html lang="en">
  ...
  <body>
  <h1 class="form-row justify-content-center"><b><u> ADDRESSBOOK</u></b></h1> 
  <br> 
  <div class="container mt-1 mb-2 p-1 shadow bg-white">
  <h3 class="form-row justify-content-center"><u>ADD NEW</u></h3>
    <form action="addressbook.php" method="POST">
        <div class="form-row justify-content-center">
            ...
            <p class="number">
               ...
               <button class="btn btn-info"> <a href="#" class="form-control">+</a> </button>
            </p> 
            </div>
            <div class="col-auto">
